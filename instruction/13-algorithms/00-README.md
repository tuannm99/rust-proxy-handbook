...
- `trie.md` — segment-based prefix lookup, used by `05-http-stack/03-router.md`
- `radix-tree.md` — compressed trie, the longest-common-prefix split, what production routers use
- `ring-buffer.md` — fixed-size circular buffer, SPSC lock-free logging, used by `08-observability/01-logging.md`
...
- `hyperloglog.md` — cardinality estimation in fixed memory, mergeable across shards, used by `07-security/09-ddos.md`
