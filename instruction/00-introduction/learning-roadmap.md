...
| `labs/02-http-server` | `05-http-stack/parser.md`, `05-http-stack/keepalive.md`, `05-http-stack/hop-by-hop-headers.md`, `01-network/http.md`, `01-network/http2.md` | hyper/hyper-util plain HTTP server |
...
| `labs/05-reverse-proxy` | `06-proxy/upstream.md`, `06-proxy/healthcheck.md`, `06-proxy/outlier-detection.md`, `06-proxy/retry.md`, `06-proxy/circuit-breaker.md`, `06-proxy/service-discovery.md`, `01-network/http.md` | hyper client forwarding to an upstream pool |
...
| `labs/10-cache` | `05-http-stack/cache.md`, `05-http-stack/cache-stampede.md`, `13-algorithms/lru.md`, `13-algorithms/lfu.md`, `13-algorithms/arc.md`, `13-algorithms/tinylfu.md` | HTTP response caching + eviction policy |
| `labs/11-rate-limit` | `07-security/ratelimit.md`, `07-security/load-shedding.md`, `13-algorithms/token-bucket.md`, `13-algorithms/sliding-window.md`, `13-algorithms/leaky-bucket.md` | token bucket / sliding window / leaky bucket |
| `labs/12-waf` | `07-security/waf.md`, `07-security/normalization.md`, `13-algorithms/aho-corasick.md` | rule-based filtering |
...
| `labs/17-ebpf` | `16-kernel/ebpf.md`, `16-kernel/xdp.md`, `07-security/ddos.md`, `07-security/slowloris.md` | XDP/eBPF packet filtering |
...
Every numbered directory also has a `README.md` index listing its files
