...
(`05-http-stack/router.md`) so a team that knows their endpoint is unsafe
can turn it off.
...
Gotcha: this conflicts with consistent hashing (`load-balancer.md`) when
...
latency (`08-observability/metrics.md`), and count hedges against the
