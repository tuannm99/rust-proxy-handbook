...
- The Linux Programming Interface (Kerrisk) — syscall-level detail behind `02-linux/`; read the epoll and signals chapters before `02-linux/06-epoll.md` and `02-linux/09-signals.md`.
