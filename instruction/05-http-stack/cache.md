...
- **`immutable`**: this will never change within its freshness lifetime,
  ...
  content-hashed asset filenames (`05-http-stack/static.md`).
...
`07-security/ip-filtering.md` and `07-security/auth.md`). And treat any
...
cache-flushing denial of service (`07-security/ddos.md`). Authenticate the
