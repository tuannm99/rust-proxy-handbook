...
- Zero To Production In Rust (Luca Palmieri) — closest real-world analog to this handbook's project arc (build a production Rust web service end-to-end); good cross-check once you reach `10-projects/project-04.md`.
