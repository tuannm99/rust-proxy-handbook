...
`02-linux/09-memory.md`'s OS-level treatment (virtual memory, paging). This is
...
- `04-buffer-pool.md` — pooling byte buffers specifically for I/O, size-classed tiers, ties into `02-linux/11-zerocopy.md`
