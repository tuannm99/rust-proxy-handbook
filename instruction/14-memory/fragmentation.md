...
(`02-linux/memory.md` covers the `#[global_allocator]` swap) usually helps
...
size as a metric (`08-observability/metrics.md`).
...
4. Instrument `proxy` with an allocated-vs-resident gauge and run
   `12-testing/load-testing.md` traffic against it for an extended period;
