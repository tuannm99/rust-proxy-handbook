...
`14-memory/allocator.md` covers general-purpose allocation. An arena is
...
`14-memory/fragmentation.md` recommends for the "mixed lifetimes"
...
situation `03-rust/pin.md` describes. Concretely: don't allocate into an
...
way you'd cap any other per-request resource (`07-security/ddos.md`).
