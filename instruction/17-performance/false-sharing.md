...
work in `08-observability/metrics.md`. You split a global counter into a
...
(`09-architecture/config.md`) are fine to pack tightly; do not pad them.
...
4. Audit your `proxy` metrics (`08-observability/metrics.md`) for
