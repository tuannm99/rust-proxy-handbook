...
theory; `05-http-stack/01-parser.md` is its HTTP-specific application and
...
exactly as `05-http-stack/01-parser.md` bounds header count and body size.
...
(`09-architecture/03-config.md`) this is the difference between a usable and
...
## Practice
1. Extend the lexer from `15-parser/01-lexer.md` into a recursive-descent
...
4. Write a Pratt parser for a small boolean expression grammar
   ...
   (`07-security/06-waf.md`) would use, and verify precedence with tests.
