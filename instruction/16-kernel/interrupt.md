...
(`16-kernel/epoll-internals.md`) — happens in a **softirq**, scheduled to
...
`16-kernel/rss.md` (hardware) and `16-kernel/rps.md` (software) solve —
...
application's threads are pinned (`16-kernel/scheduler.md`), a running
...
3. If you have access to hardware/a VM where you can set IRQ affinity
   ...
   your pinned application cores (from `16-kernel/scheduler.md`'s
