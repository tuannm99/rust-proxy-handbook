...
`02-linux/io_uring.md` covers using `io_uring` from the application side.
...
(`03-rust/async.md`'s cooperative-scheduling problem — this is exactly
...
buffer pool yourself (see `14-memory/buffer-pool.md`).
