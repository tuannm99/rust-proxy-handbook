...
2. Add a minimum-data-rate timeout around header parsing (using `labs/http-parser-raw`'s parser or hyper's equivalent) that kills a connection sending data too slowly to ever complete a request.
